    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/dashboard/artist").hasAnyRole(userRole.ARTIST.name(), userRole.CONTENT_LEAD.name())
                ...
                .requestMatchers("/api/artists/me/**", "/api/artist/me/**").hasAnyRole(userRole.ARTIST.name(), userRole.CONTENT_LEAD.name())
